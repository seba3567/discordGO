...
var (
	...
	EndpointChannelSendSoundboardSound          = func(cID string) string { return EndpointChannel(cID) + "/send-soundboard-sound" }
	...
	EndpointApplicationActivityInstance = func(aID, iID string) string {
